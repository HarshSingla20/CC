...
const alerts = [
  {
    ...
    message: "Expected rainfall of 100mm+ in next 48 hours. Avoid outdoor farming activities.",
    validUntil: "Sep 25, 6 PM",
    icon: CloudRain
  },
  {
    type: "advisory",
    title: "High Humidity Advisory",
    message: "Ideal conditions for fungal diseases. Monitor crops closely and apply preventive measures.",
    validUntil: "Sep 24, 8 AM",
    icon: Droplets
  }
];
...
const cropAdvisory = [
  {
    crop: "Pepper",
    advice: "Good time for planting. Ensure proper drainage due to expected rainfall.",
    priority: "high"
  },
  {
    crop: "Cardamom",
    advice: "Monitor for leaf blight due to high humidity. Apply fungicide if needed.",
    priority: "medium"
  },
  {
    crop: "Coffee",
    advice: "Heavy rain may affect flowering. Provide shelter if possible.",
    priority: "high"
  },
  {
    crop: "Coconut",
    advice: "Good conditions for growth. Regular maintenance recommended.",
    priority: "low"
  }
];
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-medium">{currentWeather.rainfall}%</div>
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs opacity-75">Valid until: {alert.validUntil}</p>
                        </div>
                      </div>
                    </motion.div>
                  );
